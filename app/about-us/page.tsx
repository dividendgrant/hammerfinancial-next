  ...
  return (
    <>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative w-full rounded-2xl overflow-hidden shadow-lg order-2 md:order-1" style={{ aspectRatio: "4/3" }}>
              <Image src="/about-image2.png" alt="Hammer Financial strategy" fill className="object-cover" />
            </div>
            <div className="order-1 md:order-2 space-y-6">
              {[
                ...
                <div key={item.title} className="flex gap-4">
                  <div className="w-10 h-10 bg-[#0057AD]/10 rounded-lg flex items-center justify-center shrink-0">
