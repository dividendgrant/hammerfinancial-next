    ...
    <>
      <section className="bg-[#0A2279] text-white py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <Link href="/news/" className="text-blue-300 text-sm hover:text-white transition-colors mb-4 inline-block">
            ← Back to Insights
          </Link>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-12 pt-8 border-t border-gray-100">
            <Link href="/news/" className="text-[#0057AD] font-medium hover:underline text-sm">
              ← Back to Insights
            </Link>
          </div>
        </div>
